...
Ruby, we used to be sympatico.  Rake was a solution to a problem.  It helped
make build and automation tooling easier and you won my heart away from Make.
...
about this.  Backward compatibility is hard, but the relationship doesn't work
if things that used to work stop working.
...
You suggested RVM, but to be honest that's just pileing more baggage on top
of our already strained relationship.

We've also gotten a bit sluggish havent' we?  When all I do is ask rake what
