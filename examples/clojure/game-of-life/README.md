...
* [`src/game_of_life/styles.cljs`](src/game_of_life/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/game_of_life/`](src/game_of_life/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/game_of_life/core.cljs): contains the SPA entry point, `init`
* [`test/game_of_life/`](test/game_of_life/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `game-of-life` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/game_of_life/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns game-of-life.example
  (:require [game-of-life.config :as config])
