...
(def inject-devmode-html
  (comp
     ...
     (append  (html [:script {:type "text/javascript"} "goog.require('mysterious_messages.main')"]))))

(defn browser-repl []
  (let [repl-env (weasel/repl-env :ip "0.0.0.0" :port 9001)]
    (piggieback/cljs-repl :repl-env repl-env)
    (piggieback/cljs-eval repl-env '(in-ns 'mysterious-messages.core) {})))
